...
namespace Application
{
    class MylistViewAdapter : BaseAdapter<Person>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            TextView txtAdress = row.FindViewById<TextView>(Resource.Id.txtAdress);
            txtAdress.Text = MItems[position].txtAdress;
            TextView txtTel = row.FindViewById<TextView>(Resource.Id.txtTel);
            txtTel.Text = MItems[position].txtTel;
            return row;
        }
    }
}